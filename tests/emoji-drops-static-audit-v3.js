...
for(const v of ['schema-1','hardening-9','core-9','txn-8','guards-8','final-2','release-1','product-4','product-plus-1','action-7','quality-final-1','p3-polish-v5','p4-1','case-showcase-exact-3','authority-6','case-open-bridge-11','studio-22','exact-txn-1'])if(!loader.includes(v))throw Error(`Cache version missing: ${v}`);
