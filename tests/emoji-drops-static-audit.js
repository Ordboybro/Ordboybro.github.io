...
for(const v of ['schema-1','hardening-9','core-7','txn-7','guards-8','ui-3','final-2','release-1','product-1','product-plus-1','action-6','quality-final-1','p3-2','p4-1'])if(!loader.includes(v))throw Error(`Cache version missing: ${v}`);
...
console.log('Static audit OK: 14-layer runtime, pre-boot schema migration, transaction v7 recovery/grace/fault injection, action resilience v6, P3 interaction polish, P4 engineering boundary, accessibility/performance/privacy diagnostics');
