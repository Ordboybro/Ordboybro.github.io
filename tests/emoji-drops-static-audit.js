...
for(const v of ['schema-1','hardening-9','core-7','txn-5','guards-8','ui-3','final-2','release-1','product-1','product-plus-1','action-1','quality-final-1','p3-1','p4-1'])if(!loader.includes(v))throw Error(`Cache version missing: ${v}`);
