...
for(const v of ['schema-1','hardening-9','core-7','txn-8','guards-8','ui-3','final-2','release-1','product-1','product-plus-1','action-7','quality-final-1','p3-5','p4-1'])if(!loader.includes(v))throw Error(`Cache version missing: ${v}`);
...
console.log('Static audit OK: 14-layer runtime, schema migration, transaction v8 Web Locks primary/lease fallback with ownership verification, action resilience v7, P3 v5 interaction/accessibility polish, P4 engineering boundary/touch target guarantee, accessibility/performance/privacy diagnostics');
