...
for(const x of ['VERSION=1','normalize','migrate','schemaVersion'])if(!schema.includes(x))throw Error(`Schema migration missing ${x}`);
console.log('P3/P4 self-test OK: motion, feedback, loading/empty hooks, touch, sound/haptics, schema migration, conflict diagnostics, fault hooks, performance history, privacy boundary');