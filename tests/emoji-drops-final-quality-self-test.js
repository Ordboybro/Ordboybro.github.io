...
vm.runInContext(tx,ctx,{timeout:2000});const t=ctx.window.__emojiDropsTransactions;if(t?.version!==5||t?.journal!=='emojiDropsTxnV4'||t?.commitGraceMs!==1200)throw Error('Transaction v5 contract failed');
...
console.log('Final quality self-test OK: dataset, rarities, hardening, v5 transaction rollback, long-session balance invariant');
