...
vm.runInContext(tx,ctx,{timeout:2000});const t=ctx.window.__emojiDropsTransactions;if(t?.version!==6||t?.journal!=='emojiDropsTxnV4'||t?.commitGraceMs!==1200||t?.nonBlockingLease!==true)throw Error('Transaction v6 contract failed');
...
console.log('Final quality self-test OK: dataset, rarities, hardening, v6 transaction rollback, long-session balance invariant');
