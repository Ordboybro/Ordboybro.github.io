...
const pending={v:11,id:'crash-1',label:'open',before:{...s,balance:250,inventory:[]},raw:JSON.stringify(s),beforeHash:'',startedAt:Date.now(),status:'pending'};storage.set('emojiDropsTxnV4',JSON.stringify(pending));
