...
console.log('Action resilience self-test OK: normalized action markers + deterministic pointer activation + upgrade recovery + modal lifecycle + keyboard focus safety + one-shot verification/retry, no polling, runtime loader contract');
