...
if(!t||t.version!==5||t.maxHistory!==200||t.journal!=='emojiDropsTxnV4'||t.commitGraceMs!==1200)throw new Error('Transaction v5 contract missing');
...
console.log('Transaction v5 self-test OK: journal, rollback, hash verification, commit metadata, grace window');
