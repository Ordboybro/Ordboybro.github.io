...
if(!/__emojiDropsMutationHub/.test(plus))throw Error('Product-plus shared mutation resilience missing');
console.log('Product-plus self-test OK: favorites, action history, market cancellation, case details, shared mutation resilience');
