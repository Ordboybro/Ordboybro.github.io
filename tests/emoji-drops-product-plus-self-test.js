...
for(const marker of ['ed-fav','ed-history','case-detail','emojiDropsFavoritesV1','emojiDropsHistoryV1','product-plus-6','function liveSlot','ed-live-slot','Live Drops'])if(!plus.includes(marker)&&!loader.includes(marker))throw Error(`Product-plus contract missing: ${marker}`);
