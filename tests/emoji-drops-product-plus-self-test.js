...
if(!/DOMContentLoaded/.test(plus)||!/function boot\(\)/.test(plus))throw Error('Product-plus boot resilience missing');
console.log('Product-plus self-test OK: favorites, action history, case details and resilient boot');
