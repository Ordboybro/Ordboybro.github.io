...
need(/const version=329;/.test(app)&&index.includes('js/app-v2.js?v=runtime-329'),'runtime/cache contract must be 329');
...
need(app.includes('market-v26-19')&&market.includes('version:31')&&market.includes('destroy'),'Market lifecycle owner/cache contract missing');
