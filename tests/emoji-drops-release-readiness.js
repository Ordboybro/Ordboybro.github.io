...
need(/const version=336;/.test(app)&&index.includes('js/app-v2.js?v=runtime-336'),'runtime/cache contract must be 336');
need(app.includes('supabase-auth-8')&&app.includes('core-25')&&app.includes('final-11'),'runtime cache contract missing');
need(app.includes('live-final-20'),'Live Drops cache contract missing');need(app.includes('case-showcase-exact-40'),'Exact case cache contract missing');
...
need(live.includes('version:20'),'Live Drops owner version mismatch');
...
const supa=fs.readFileSync('js/supabase-config.js','utf8'),authCfg=fs.readFileSync('js/supabase-auth.js','utf8');
need(supa.includes('publishableKey')&&!supa.includes('anonKey'),'publishable-key config naming drift');
need(authCfg.includes('publishableKey')&&!authCfg.includes('anonKey'),'publishable-key auth bridge naming drift');
