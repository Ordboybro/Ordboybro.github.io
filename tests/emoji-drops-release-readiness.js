...
need(core.includes("claim_daily_server")&&!/S\.balance\+=reward/.test(core.slice(core.indexOf('async function claimDaily()'),core.indexOf('async function sell('))),'authenticated Daily still mutates local balance directly');
