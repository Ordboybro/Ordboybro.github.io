...
need(/const version=334;/.test(app)&&index.includes('js/app-v2.js?v=runtime-334'),'runtime/cache contract must be 334');
need(app.includes('supabase-auth-8')&&app.includes('core-24')&&app.includes('final-11'),'runtime cache contract missing');
