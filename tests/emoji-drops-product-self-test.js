...
for(const marker of ['emoji-drops-product-layer.js?v=product-2','product-layer','emoji-drops-transaction-layer.js?v=txn-8'])if(!loader.includes(marker))throw Error(`Product loader marker missing: ${marker}`);
