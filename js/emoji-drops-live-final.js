...
let timer=0,interval=0,observer=0,channel=0,realtimeReady=false,fallbackTimer=0,lastKey='',lastPaintState='',inFlight=false,booted=false,destroyed=false,generation=0,authReady=0,authChange=0,visibilityHandler=0,pagehideHandler=0,pageshowHandler=0,lastRows=[];
