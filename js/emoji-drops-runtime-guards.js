(()=>{'use strict';
/* Emoji Drops runtime guards v4. Emergency bonus only when balance cannot afford the cheapest case. Max 5 claims per local day. No visual redesign. */
const KEY='emojiDropsStateV3',MAX_DAILY=5,BONUS=250,BLOCK_MS=100*365*24*60*60*1000;
