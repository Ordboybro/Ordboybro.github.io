...
function install(){document.addEventListener('click',e=>{const b=e.target?.closest?.('[data-view]'),v=b?.getAttribute('data-view');if(!V.includes(v))return;setTimeout(()=>ensure(v),0)},false)}
