...
if(e.type==='click'){const recentTouch=now-lastTouch<TOUCH_CLICK_GUARD_MS;if(recentTouch){lastTouchTarget=null;e.preventDefault();e.stopImmediatePropagation();return}if(e.pointerType==='touch'){e.preventDefault();e.stopImmediatePropagation();return}commit(v)}}
