...
try{
  ...
  write('js/emoji-drops-performance-guard.js?v=perf-1');
  write('js/emoji-drops-core.js?v=core-7');
  if(typeof window.__emojiDropsRestoreTimerApi==='function')window.__emojiDropsRestoreTimerApi();
  write('js/emoji-drops-runtime-guards.js?v=guards-8');
  write('js/emoji-drops-ui-polish.js?v=ui-3');
  window.__emojiDropsRuntimeLoader.loaded=['dataset-bridge','hardening','performance-guard','core','runtime-guards','ui-polish'];
