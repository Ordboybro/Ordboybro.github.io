...
/* action-1 compatibility marker: action resilience moved through action-2, action-3, action-4 and action-5. */
const version=55;
...
try{
  ...
  write('js/emoji-drops-transaction-layer.js?v=txn-7');
  ...
  write('js/emoji-drops-action-resilience.js?v=action-5');
