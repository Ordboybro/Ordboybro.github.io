...
@media (orientation:landscape) and (max-height:500px){
  ...
  .edx-open button{height:48px;min-height:48px!important;font-size:16px;border-radius:13px}.ed-case>.ed-btn{height:48px;min-height:48px!important}.ed-case>.ed-btn:active{transform:none!important}
