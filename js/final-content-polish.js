...
try{
 if(typeof cases==='object'&&typeof casePrices==='object'){
  Object.assign(casePrices,ED_ECONOMY);
  cases.space=[
...
/* app-v2-core applies its legacy economy during initialization. Re-apply the single canonical table once core has initialized. */
