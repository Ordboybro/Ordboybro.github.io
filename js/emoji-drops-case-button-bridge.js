...
function install(){
  ...
  if(canonical&&typeof canonical.open==='function'&&canonical.version===5){
    ...
    try{
      Object.defineProperty(window,'EmojiDropsCaseShowcaseExact',{configurable:true,enumerable:true,get:()=>canonical,set:value=>{if(value&&value.version===5)canonical=value}});
    }catch{}
  }
